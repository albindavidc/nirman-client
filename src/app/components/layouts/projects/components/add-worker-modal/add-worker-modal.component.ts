...
@Component({
  ...
  styleUrl: './add-worker-modal.component.scss',
})
export class AddWorkerModalComponent implements OnInit {
  dialogRef = inject<MatDialogRef<AddWorkerModalComponent>>(MatDialogRef);
  data = inject<AddWorkerDialogData>(MAT_DIALOG_DATA);

...
import { ProcurementAssistantComponent } from './procurement-assistant/procurement-assistant.component';
import { ProcurementForecastComponent } from './procurement-forecast/procurement-forecast.component';
...
@Component({
  ...
  imports: [
    ...
    ProcurementAssistantComponent,
    ProcurementForecastComponent,
  ],
  ...
  private initCharts(): void {
    ...
    setTimeout(() => {
          ...
          series: [
            {
              ...
              data: [
                ...
                {
                  value:
                    users.totalUsers - users.activeUsers - users.blockedUsers,
                  name: 'Inactive',
                  itemStyle: { color: '#775a0b' },
                },
              ],
            },
          ],
      ...
      if (this.projectChartRef) {
        this.projectChartInstance = echarts.init(
        ...
        const projectChartOption: EChartsOption = {
          ...
          xAxis: [
            {
              type: 'category',
              data: ['Total', 'Active', 'Pending', 'Completed'],
      ...
      if (this.materialChartRef) {
        this.materialChartInstance = echarts.init(
          this.materialChartRef.nativeElement,
        );
          ...
          series: [
            {
              ...
              data: [
                {
                  value: materialRequests.approvedMaterialRequests,
                  name: 'Approved',
                },
              ],
            },
